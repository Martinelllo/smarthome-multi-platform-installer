...
class OpenCloseControlModule(ModuleBase):
    def __init__(self, module_config: ModuleConfig):
        ...
        self.__control_open_gpio = get_gpio_for(module_config.get_pin_by_key('control_open_pin'))
        if self.__control_open_gpio is None: raise ValueError('control_open_pin is not set')
        
        self.__control_close_gpio = get_gpio_for(module_config.get_pin_by_key('control_close_pin'))
        if self.__control_close_gpio is None: raise ValueError('control_close_pin is not set')
        
        self.__button_open_gpio = get_gpio_for(module_config.get_pin_by_key('button_open_pin'))
        self.__button_close_gpio = get_gpio_for(module_config.get_pin_by_key('button_close_pin'))
