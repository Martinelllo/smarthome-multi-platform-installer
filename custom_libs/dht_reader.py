...
class DHTSensor:
   ...
   The sensor DHT21 is supported to.
   ...
   def __init__(self, pi: pigpio.pi, gpio, LED=None, power=None):
      """
   ...
   def isValid(self):
      """Checks the last readings vor plausibility."""
      return -40 <= self.temperature() <= 80 and 0 <= self.humidity() <= 99,9
